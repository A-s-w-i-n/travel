const Carosal = ({title,disc, image, selectedIndex = 0, onSelect }) => {
  return (
    ...
    >
      <div className="absolute inset-0 flex flex-col md:flex-row justify-between items-center md:items-center text-center md:text-left text-white px-6 gap-8 md:gap-0">
        ...
        {/* Carousel Thumbnails */}
        <div className="flex  justify-center md:justify-start gap-4 md:gap-4 mt-6 md:mt-10 w-full md:w-auto">
          {image.map((img, index) => (
            <div
              data-aos="fade-down-left"
              className={`w-28 h-28 md:w-48 md:h-48 rounded-lg  ${
